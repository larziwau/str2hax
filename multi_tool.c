...
int main(int argc, char *argv[]) {
    if (argc == 1) {
        ...
        printf("operations:\n");
        printf("\tk min/max # output.bin\t\tOutput a file with the correct number of decimals to reach a k=# allocation\n");
        printf("\t\t\t\t\tmin/max change whether the decimal is just enough or just below limit\n");
        printf("\n");
        printf("\tc input.bin output.bin\t\tConverts binary input file to decimal needed\n");
        printf("\n");
        printf("\ts\t\t\t\tDisplays decimal lengths for all possible values of k\n");
        return 0;
    }
